...
def test_basic_pan_tilt():
    ...
    expected_trans = np.array([
        [0.8944271909999159, -0.0975900072948533, -0.4364357804719848, 0.0000000000000000],
        [0.0000000000000000, 0.9759000729485332, -0.2182178902359924, 0.0000000000000000],
        [0.4472135954999580, 0.1951800145897066, 0.8728715609439696, 0.0000000000000000],
...
def test_modified_rest_trans():
    ...
    # MATLAB reference values
    expected_trans = np.array([
        [0.9486832980505138, -0.0493864798324795, -0.3123475237772121, 2.0000000000000000],
        [0.0000000000000000, 0.9877295966495896, -0.1561737618886061, 1.0000000000000000],
        [0.3162277660168379, 0.1481594394974385, 0.9370425713316364, 3.0000000000000000],
        [0.0000000000000000, 0.0000000000000000, 0.0000000000000000, 1.0000000000000000]
    ])
