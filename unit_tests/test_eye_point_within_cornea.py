...
def test_basic_cases() -> None:
    ...
    expected_p1 = Position3D(0.0, 0.0, -12.330)
    ...
    p2 = e.cornea.center
    expected_p2 = Position3D(0.0, 0.0, -4.350)
    ...
    expected_p3 = Position3D(0.0, 0.0, -5.250)
...
def test_boundary_cases() -> None:
    ...
    expected_p4 = Position3D(0.0, 0.0, -8.790001)
    ...
    apex = e.cornea.get_apex_position()
    p6 = Position3D(apex.x + 1.0 * perp_direction.x, apex.y + 1.0 * perp_direction.y, apex.z + 1.0 * perp_direction.z)
    expected_p6 = Position3D(1.0, 0.0, -12.330)
    ...
    expected_p7 = Position3D(0.0, 0.0, -14.100)
