...
def test_homogeneous_coordinates():
    ...
    expected_U0 = np.array([1.0000000000000000, 0.0000000000000000, -2.0000000000000000, 1.0000000000000000])
    expected_Ud = np.array([0.0000000000000000, 0.0000000000000000, -1.0000000000000000, 0.0000000000000000])
