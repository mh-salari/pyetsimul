...
from pyetsimul.geometry.intersections import intersect_ray_conic, intersect_ray_sphere
from pyetsimul.types import Direction3D, Point3D, Position3D, Ray


def test_conic_equals_sphere_on_axis() -> None:
    ...
    assert sphere_result1.intersects
    assert conic_result1.intersects
    assert sphere_result2.intersects
    assert conic_result2.intersects
...
def test_conic_equals_sphere_off_axis() -> None:
