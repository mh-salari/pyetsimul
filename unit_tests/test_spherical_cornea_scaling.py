...
def test_reference_values() -> None:
    ...
    assert cornea._r_cornea_default == 7.98e-3  # noqa: SLF001
    assert cornea._posterior_radius_default == 6.22e-3  # noqa: SLF001
    assert cornea._thickness_offset_default == 1.15e-3  # noqa: SLF001
    assert cornea._cornea_depth_default == 3.54e-3  # noqa: SLF001
    assert cornea._cornea_center_to_rotation_center_default == 10.20e-3  # noqa: SLF001
