...
def test_two_intersections():
    ...
    expected_pos1 = np.array([0.0, 0.0, -1.0, 1.0])
    expected_pos2 = np.array([0.0, 0.0, 1.0, 1.0])
...
def test_tangent_intersection():
    ...
    R0 = np.array([0.0, 1.0, -2.0, 1.0])  # Ray origin
    Rd = np.array([0.0, 0.0, 1.0, 0.0])  # Ray direction
    S0 = np.array([0.0, 0.0, 0.0, 1.0])  # Sphere center
    Sr = 1.0  # Sphere radius
    ...
    expected_pos = np.array([0.0, 1.0, 0.0, 1.0])
...
def test_ray_missing_sphere():
    ...
    R0 = np.array([0.0, 2.0, -2.0, 1.0])  # Ray origin
    Rd = np.array([0.0, 0.0, 1.0, 0.0])  # Ray direction
    S0 = np.array([0.0, 0.0, 0.0, 1.0])  # Sphere center
    Sr = 1.0  # Sphere radius
...
def test_ray_inside_sphere():
    ...
    R0 = np.array([0.0, 0.0, 0.0, 1.0])  # Ray origin (at center)
    ...
    # MATLAB reference values
    expected_pos1 = np.array([-2.0, 0.0, 0.0, 1.0])
    expected_pos2 = np.array([2.0, 0.0, 0.0, 1.0])
...
def test_non_unit_direction():
    ...
    R0 = np.array([0.0, 0.0, -3.0, 1.0])  # Ray origin
    Rd = np.array([0.0, 0.0, 2.0, 0.0])  # Ray direction (length 2.0)
    S0 = np.array([0.0, 0.0, 0.0, 1.0])  # Sphere center
    Sr = 1.0  # Sphere radius
...
def test_output_properties():
    ...
    dist1 = np.linalg.norm(pos1[:3] - S0[:3])
    dist2 = np.linalg.norm(pos2[:3] - S0[:3])
    assert np.isclose(dist1, Sr, rtol=1e-12)
    assert np.isclose(dist2, Sr, rtol=1e-12)

    # pos1 should be closer to ray origin than pos2
    dist_to_origin1 = np.linalg.norm(pos1[:3] - R0[:3])
    dist_to_origin2 = np.linalg.norm(pos2[:3] - R0[:3])
