...
def test_default_n():
    ...
    expected_first_5 = np.array([
        [0.0030000000000000, 0.0000000000000000, -0.0087900000000000, 1.0000000000000000],
        [0.0028531695488855, 0.0009270509831248, -0.0087900000000000, 1.0000000000000000],
        [0.0024270509831248, 0.0017633557568774, -0.0087900000000000, 1.0000000000000000],
        [0.0017633557568774, 0.0024270509831248, -0.0087900000000000, 1.0000000000000000],
        [0.0009270509831248, 0.0028531695488855, -0.0087900000000000, 1.0000000000000000]
    ]).T
...
def test_custom_n_8():
    ...
    expected_points = np.array([
        [0.0030000000000000, 0.0000000000000000, -0.0087900000000000, 1.0000000000000000],
        [0.0021213203435596, 0.0021213203435596, -0.0087900000000000, 1.0000000000000000],
        [0.0000000000000000, 0.0030000000000000, -0.0087900000000000, 1.0000000000000000],
        [-0.0021213203435596, 0.0021213203435596, -0.0087900000000000, 1.0000000000000000],
        [-0.0030000000000000, 0.0000000000000000, -0.0087900000000000, 1.0000000000000000],
        [-0.0021213203435596, -0.0021213203435596, -0.0087900000000000, 1.0000000000000000],
        [-0.0000000000000000, -0.0030000000000000, -0.0087900000000000, 1.0000000000000000],
...
def test_custom_corneal_radius():
    ...
    expected_points = np.array([
        [0.0037593984962406, 0.0000000000000000, -0.0110150375939850, 1.0000000000000000],
        [0.0032557346006934, 0.0018796992481203, -0.0110150375939850, 1.0000000000000000],
        [0.0018796992481203, 0.0032557346006934, -0.0110150375939850, 1.0000000000000000],
        [0.0000000000000000, 0.0037593984962406, -0.0110150375939850, 1.0000000000000000],
        [-0.0018796992481203, 0.0032557346006934, -0.0110150375939850, 1.0000000000000000],
        [-0.0032557346006934, 0.0018796992481203, -0.0110150375939850, 1.0000000000000000],
        [-0.0037593984962406, 0.0000000000000000, -0.0110150375939850, 1.0000000000000000],
        [-0.0032557346006934, -0.0018796992481203, -0.0110150375939850, 1.0000000000000000],
...
def test_custom_rest_position():
    ...
    expected_points = np.array([
        [-0.0040941482630701, 0.0000000000000000, -0.0083367889501894, 1.0000000000000000],
        [-0.0051548084348499, 0.0025980762113533, -0.0072761287784096, 1.0000000000000000],
        [-0.0072761287784096, 0.0025980762113533, -0.0051548084348499, 1.0000000000000000],
        [-0.0083367889501894, 0.0000000000000000, -0.0040941482630701, 1.0000000000000000],
        [-0.0072761287784096, -0.0025980762113533, -0.0051548084348499, 1.0000000000000000],
        [-0.0051548084348499, -0.0025980762113533, -0.0072761287784096, 1.0000000000000000]
    ]).T
