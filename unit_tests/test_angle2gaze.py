...
def test_positive_angles():
    ...
    expected = np.array(
        [0.0978433950072557, -0.9751703272018158, 0.1986693307950612, 0.0]
    )
    np.testing.assert_allclose(result, expected, rtol=1e-10)
...
def test_negative_angles():
    ...
    expected = np.array(
        [-0.1447924628309112, -0.9580325796404553, -0.2474039592545229, 0.0]
    )
    np.testing.assert_allclose(result, expected, rtol=1e-10)
...
def test_custom_rest_position():
    ...
    expected = np.array(
        [0.0998334166468282, -0.9900332889206207, 0.0993346653975306, 0.0]
    )
    np.testing.assert_allclose(result, expected, rtol=1e-10)
