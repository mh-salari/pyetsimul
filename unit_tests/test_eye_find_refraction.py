...
def test_basic_refraction():
    ...
    expected_I = np.array([0.0036221057296969, 0.0014867621985687, -0.0113034371535094, 1.0000000000000000])
...
def test_close_camera():
    ...
    # MATLAB reference values
    expected_I = np.array([0.0042042117071795, 0.0017993479882829, -0.0108896751248267, 1.0000000000000000])
