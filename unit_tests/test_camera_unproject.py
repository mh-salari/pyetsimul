...
def test_multiple_points_unprojection():
    ...
    # MATLAB reference values
    expected_pos = np.array([
        [0.0000000000000000, 10.4166666666666679, -15.6250000000000000, 20.8333333333333357],
        [0.0000000000000000, 5.2083333333333339, -7.8125000000000000, 10.4166666666666679],
        [-300.0000000000000000, -300.0000000000000000, -300.0000000000000000, -300.0000000000000000],
