...
def plot_error_vectors(X, Y, U, V, errors, 
                      title_prefix="",
                      convert_to_mm=True,
                      width=0.001,
                      max_arrow_ratio=0.3,
    ...
    ax.quiver(X_pos, Y_pos, U_scaled, V_scaled,
             scale=1, scale_units='xy', angles='xy',
             alpha=1, width=width, color='black')
    ...
    error_stats = (f'Max: {errors["mtr"]["max"] * 1e3:.2f} {unit_str}, '
