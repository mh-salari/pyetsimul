...
def print_eye_parameters(eye, title="Eye Parameters"):
    ...
    print(
        f"cornea_center_to_rotation_center: {eye.cornea_center_to_rotation_center*1000:.3f} mm"
    )
...
# Print parameters
print_eye_parameters(
    e_default, f"Default Eye (r_cornea = {e_default.r_cornea*1000:.1f} mm)"
)
