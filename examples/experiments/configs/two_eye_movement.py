"""Two eye movement experiment configuration with binocular setup."""
...
# Experiment metadata
experiment_name = "two_eye_movement"
output_dir = Path(__file__).parent.parent / "outputs"

# Two eye configuration - left and right eyes
left_eye = Eye()
...
# Two camera configuration - stereo setup
...
# Four light configuration - surrounding the eyes
lights = [
...
# Eye movement pattern - both eyes move together in XY plane
# Testing binocular eye tracking robustness to head movement
