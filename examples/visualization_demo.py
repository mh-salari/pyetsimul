...
def main():
    ...
    rest_orientation = np.array([[1, 0, 0], [0, 0, 1], [0, 1, 0]])  # Looking out along negative y-axis
    ...
    print(f"- Eye position: ({e.trans[0,3]*1000:.1f}, {e.trans[1,3]*1000:.1f}, {e.trans[2,3]*1000:.1f}) mm")
    print(f"- Light 1 position: ({l1.position[0]*1000:.1f}, {l1.position[1]*1000:.1f}, {l1.position[2]*1000:.1f}) mm")
    print(f"- Light 2 position: ({l2.position[0]*1000:.1f}, {l2.position[1]*1000:.1f}, {l2.position[2]*1000:.1f}) mm") 
    print(f"- Camera position: ({c.trans[0,3]*1000:.1f}, {c.trans[1,3]*1000:.1f}, {c.trans[2,3]*1000:.1f}) mm")
    print(f"- Target position: ({target_point[0]*1000:.1f}, {target_point[1]*1000:.1f}, {target_point[2]*1000:.1f}) mm")
    ...
    for i, light in enumerate(lights):
        ...
        if cr_3d is not None:
            print(f" CR successfully found at: ({cr_3d[0]*1000:.1f}, {cr_3d[1]*1000:.1f}, {cr_3d[2]*1000:.1f}) mm")
        else:
